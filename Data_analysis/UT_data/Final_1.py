...
file_path = '../ddu/program_default_metric1050.xlsx'
new_file_path = '../ddu/Audi_ddu_1050_class.xlsx'
sheet_name = 'HIS (Classes,Methods,Types)'
...
#............................. Program Starts .............................
def pros(var_1,var_2,var_3):
    global file_path
    global new_file_path
    global sheet_name
    file_path = var_1
    if(1 == var_3):
        new_file_path = var_2 + '/unit_class.xlsx'
        sheet_name = 'HIS (Classes,Methods,Types)'
    else:
        new_file_path = var_2 + '/unit_function.xlsx'
